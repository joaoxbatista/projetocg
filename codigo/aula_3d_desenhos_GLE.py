...
def desenha_luminaria():
    ...
    while (cont <= 8): #quanto maior mais fino a ponta( a quant de voltas)
        cont += 0.3
        glutSolidTorus(0.06,0.5,100,100)
...
def desenho():
    ...
    # OBJETO 1 - Chapa Curva em 3D
   # desenha_com_poligonos()
    ...
    # OBJETO 5 - Piso
    glColor3f(1.0, 0.7, 0.0) # cor RGB
    glPushMatrix()                # Push e Pop Isolam os efeitos das transforma�oes no objeto
    #glTranslate( 0.0, 0.0, 0.0)  #Transta�ao do objeto
    #glRotatef(-90, 1.0, 0.0, 0.0)     #Rota�ao do objeto
    glBegin(GL_POLYGON)
...
def iluminacao_da_cena():
    ...
    posicaoLuz2=[0.0, 1.1, 0.0, 1.0]  # última coord como 0 pra funcionar como vetor da luz direcional
